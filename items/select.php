        ...
        <div class="item-search">
            ...
            <div class="search-options">
                <form id="advanced-select-item-search">
                    <div class="field">
                        <label for="advanced-keyword">Keyword(s)</label>
                        <input type="text" name="advanced-keyword">
                    </div>
                    <div class="field">
                        <label>By ID</label>
                        <input type="text">
    ...
    <div class="modal-content">
        <div class="item-list">
            <div class="item">
                ...
                <span class="directions">Click name to toggle details</span>
        ...
        <div class="element-set">
            <div id="place-item-type-metadata-physical-description" class="element">
                <h3>Physical Description</h3>
                <div class="element-text">Black and white photograph, Size: 8w x 10h</div>
            </div><!-- end element -->
            <div id="place-item-type-metadata-location" class="element">
                <h3>Location</h3>
