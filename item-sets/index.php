...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>
                <a href="#">Histories of the National Mall</a>
                <div class="actions">
        ...
        <tr>
            ...
            <td>
                <a href="#">Cooper Hewitt Collection</a>
                <div class="actions">
                    <a href="#" class="fa-ellipsis-h"><span class="screen-reader-text">More Details</span></a>
                    <a href="#" class="fa-pencil"><span class="screen-reader-text">Edit</span></a>
                    <a href="#" class="fa-trash-o"><span class="screen-reader-text">Delete</span></a>
        ...
        <tr>
            ...
            <td>
                <a href="#">Martha Washington: A Life</a>
                <div class="actions">
                    <a href="#" class="fa-ellipsis-h"><span class="screen-reader-text">More Details</span></a>
                    <a href="#" class="fa-pencil"><span class="screen-reader-text">Edit</span></a>
                    <a href="#" class="fa-trash-o"><span class="screen-reader-text">Delete</span></a>
        ...
        <tr>
            ...
            <td>
                <a href="#">Bracero History ArchiveH</a>
                <div class="actions">
                    <a href="#" class="fa-ellipsis-h"><span class="screen-reader-text">More Details</span></a>
                    <a href="#" class="fa-pencil"><span class="screen-reader-text">Edit</span></a>
                    <a href="#" class="fa-trash-o"><span class="screen-reader-text">Delete</span></a>
        ...
        <tr>
            ...
            <td>
                <a href="#">Hurricane Digital Memory Bank</a>
                <div class="actions">
                    <a href="#" class="fa-ellipsis-h"><span class="screen-reader-text">More Details</span></a>
                    <a href="#" class="fa-pencil"><span class="screen-reader-text">Edit</span></a>
                    <a href="#" class="fa-trash-o"><span class="screen-reader-text">Delete</span></a>
        ...
        <tr>
            ...
            <td>
                <a href="#">Probing the Past: Virginia and Maryland Probate Inventories</a>
                <div class="actions">
                    <a href="#" class="fa-ellipsis-h"><span class="screen-reader-text">More Details</span></a>
                    <a href="#" class="fa-pencil"><span class="screen-reader-text">Edit</span></a>
                    <a href="#" class="fa-trash-o"><span class="screen-reader-text">Delete</span></a>
        ...
        <tr>
            ...
            <td>
                <a href="#">Critical Infrastructure Protection Oral History Project</a>
                <div class="actions">
                    <a href="#" class="fa-ellipsis-h"><span class="screen-reader-text">More Details</span></a>
                    <a href="#" class="fa-pencil"><span class="screen-reader-text">Edit</span></a>
                    <a href="#" class="fa-trash-o"><span class="screen-reader-text">Delete</span></a>
